  ...
  <body>
    ...
    <section class="py-5">
      <div class="container">
        <h2
          class="text-center section-title animate__animated animate__fadeInUp"
        >
          What Drives Us
        </h2>
        <div class="row g-4">
          ...
          <div class="col-md-4">
            <div class="card p-4 text-center mission-card fade-in">
              ...
              <p>
                At AS Solution and Implementation, we’re committed to delivering
                premium-quality t-shirts that combine comfort, durability, and
          ...
          <div class="col-md-4">
            <div class="card p-4 text-center mission-card fade-in">
              ...
              <p>
                ...
                practices to reduce our environmental footprint and promote
                ethical fashion.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card p-4 text-center mission-card fade-in">
              ...
              <p>
                Our mission is to continuously evolve based on customer
                feedback, delivering fresh, trend-driven designs that align with
