...
<body>
  ...
  <div class="topbar">
    <div class="contact-info">
      <span><i class="fa fa-envelope me-1"></i> Raja@bellbuckgroups.com</span>
      <span><i class="fa fa-phone me-1"></i> +91 9843394847</span>
    </div>
  ...
  <div class="container-fluid p-0 mb-5">
    <div class="owl-carousel header-carousel position-relative">
      <div class="owl-carousel-item position-relative">
        <img class="img-fluid" src="img/garment_baner_1.jpg" style="height: 600px !important" alt="T-shirt Banner" />
            ...
            <div class="row justify-content-start">
              <div class="col-10 col-lg-8">
                <h5 class="text-white text-uppercase mb-3 animated slideInDown">
                  Latest T-Shirt Collection
                </h5>
                <h1 class="display-3 text-white animated slideInDown mb-4">
                  Express Your Style with Trendy T-Shirts
                </h1>
                <p class="fs-5 fw-medium text-white mb-4 pb-2">
                  Browse our newest range of stylish, comfortable T-shirts
                  crafted for every mood, season, and occasion.
                </p>
      ...
      <div class="owl-carousel-item position-relative">
        <img class="img-fluid" src="img/garment_baner_2.avif" alt="T-shirt Banner 2" style="height: 600px !important" />
        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center"
          style="background: rgba(0, 0, 0, 0.4)">
          <div class="container">
            <div class="row justify-content-start">
              <div class="col-10 col-lg-8">
                ...
                <h1 class="display-3 text-white animated slideInDown mb-4">
                  Stay Cool & Comfortable All Day Long
                </h1>
                <p class="fs-5 fw-medium text-white mb-4 pb-2">
                  Discover soft, breathable T-shirts made from high-quality
                  cotton — perfect for casual wear and layering.
                </p>
                <a href="#" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                  Shop Now
                </a>
    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <h1 class="mb-4">
            Focus Garment – Your Trusted Partner in Knit
            Garment Excellence
          </h1>
          <p class="mb-4">
            At Focus Garment, we specialize in providing
          ...
          <div class="bg-primary d-flex align-items-center p-4 mt-5">
            ...
            <div class="ms-3">
              ...
              <h3 class="m-0 text-secondary">+91 9843394847</h3>
            </div>
          </div>
        </div>
  ...
  <div class="container-xxl py-5">
    <div class="container">
      <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="mb-5">
          Delivering Precision and Quality in Every Stitch – Your Trusted
          Partner in Knit Garment Manufacturing.
        </h1>
      </div>
      ...
      <div class="row g-4 justify-content-center">
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Hoodie.jpeg" class="card-img-top" style="height: 280px; object-fit: cover"
              alt="T-Shirt Image" />
        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Shorts.jpeg" class="card-img-top" style="height: 280px; object-fit: cover"
              alt="T-Shirt Image" />
            <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Track-pant.jpeg" style="height: 280px; object-fit: cover" class="card-img-top"
              alt="T-Shirt Image" />
            <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Women's-tops.jpeg" style="height: 280px; object-fit: cover" class="card-img-top"
              alt="T-Shirt Image" />
            <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Women's-hoodie.jpeg" style="height: 280px; object-fit: cover" class="card-img-top"
              alt="T-Shirt Image" />
            <div class="card-body text-center">
        ...
        <div class="col-md-3 mb-3">
          <div class="card h-100 shadow-sm">
            <img src="img/Women's-fashion-wear.jpeg" style="height: 280px; object-fit: cover" class="card-img-top"
              alt="T-Shirt Image" />
            <div class="card-body text-center">
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
          ...
          <p class="text-white mb-0">Branded T-Shirt Styles</p>
        </div>
      ...
      <div class="col-md-12 col-lg-9">
        <div class="ms-lg-5 ps-lg-5">
          <div class="text-center text-lg-start wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Explore Our T-Shirt Offerings</h1>
          </div>
          ...
          <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="bg-light p-4">
              ...
              <h4 class="mb-3">Premium Quality Fabrics</h4>
              <p>
                We use high-grade cotton and blends that ensure softness,
                breathability, and long-lasting wear.
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>100% Cotton &
                Cotton-Blend Options
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Colorfast &
                Shrink-Resistant
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Tested for
                Quality
              </p>
            ...
            <div class="bg-light p-4">
              ...
              <h4 class="mb-3">Custom Printing Services</h4>
              <p>
                Get your brand, logo, or artwork printed with precision using
                DTG, screen, or heat transfer methods.
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Custom Designs
                Available
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Bulk & Individual
                Orders
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>High-Resolution
                Printing
              </p>
              <a href="#" class="btn bg-white text-primary w-100 mt-2">
                Read More<i class="fa fa-arrow-right text-secondary ms-2"></i>
            ...
            <div class="bg-light p-4">
              ...
              <h4 class="mb-3">Trendy & Seasonal Collections</h4>
              <p>
                From minimalist basics to bold graphic tees, we launch fresh
                designs for every season and trend.
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Men’s, Women’s &
                Unisex Styles
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Regular Product
                Updates
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Fashion-Forward
                Designs
              </p>
              <a href="#" class="btn bg-white text-primary w-100 mt-2">
                Read More<i class="fa fa-arrow-right text-secondary ms-2"></i>
            ...
            <div class="bg-light p-4">
              ...
              <h4 class="mb-3">Fast Delivery & Packaging</h4>
              <p>
                Nationwide delivery with secure packaging and real-time
                tracking for every T-shirt order you place.
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Secure,
                Tamper-Proof Packing
              </p>
              <p class="text-primary fw-medium">
                <i class="fa fa-check text-success me-2"></i>Real-Time Order
                Tracking
              </p>
              <p class="text-primary fw-medium">
      ...
      <div class="owl-carousel testimonial-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="testimonial-item text-center">
          <div class="testimonial-text bg-light text-center p-4 mb-4">
            <p class="mb-0">
              The cotton T-shirt I received is incredibly soft and fits
              perfectly! The print quality is top-notch and the colors haven’t
        ...
        <div class="testimonial-item text-center">
          <div class="testimonial-text bg-light text-center p-4 mb-4">
            <p class="mb-0">
              I ordered three graphic tees and they’re amazing! Excellent
              fabric, vibrant prints, and great customer service. I’ll
        ...
        <div class="testimonial-item text-center">
          <div class="testimonial-text bg-light text-center p-4 mb-4">
            <p class="mb-0">
              The oversized T-shirt I got is perfect for workouts and casual
              wear. It’s breathable, durable, and super stylish. I wear it
        ...
        <div class="testimonial-item text-center">
          <div class="testimonial-text bg-light text-center p-4 mb-4">
            <p class="mb-0">
              I’ve tried many T-shirts, but the comfort and fit from Eagle
              Vision’s collection is unmatched. The stitching and finish are
              very premium.
            </p>
          </div>
        ...
        <div class="testimonial-item text-center">
          <div class="testimonial-text bg-light text-center p-4 mb-4">
            <p class="mb-0">
              I purchased a plain white tee and a custom printed one—both are
              great! The custom print came out exactly how I wanted it. Superb
              experience!
            </p>
          </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <iframe class="position-relative w-100"
            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d62690.726688361996!2d77.41934462070714!3d10.874639547690785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s%20K.Chettipalayam%2C%20Dharapuram%20road%2C%20tiruppur%20-%20641606!5e0!3m2!1sen!2sin!4v1756207657299!5m2!1sen!2sin"
  ...
  <script>
    document.getElementById("enquiryForm").addEventListener("submit", function (e) {
      ...
      const phoneNumber = "919843394847";
    ...
    <div class="container py-5">
      <div class="row g-5">
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            <i class="fa fa-envelope me-3"></i>Raja@bellbuckgroups.com
          </p>
